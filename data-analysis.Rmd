...
From the correlation plot, it is evident that there is a strong (negative) correlation between `rd.strq` and `rd.cmrq`. Further inspecting the relation between the 2 columns:
